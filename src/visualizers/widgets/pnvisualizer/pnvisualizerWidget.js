...
define(['css!./styles/pnvisualizerWidget.css'], function () {
    ...
    pnvisualizerWidget.prototype._initialize = function () {
        ...
        this._el.append('<h3>pnvisualizer Events:</h3>');
    ...
    pnvisualizerWidget.prototype.addNode = function (desc) {
        if (desc) {
    ...
    pnvisualizerWidget.prototype.removeNode = function (gmeId) {
        var desc = this.nodes[gmeId];
        this._el.append('<div>Removing node "' + desc.name + '"</div>');
        delete this.nodes[gmeId];
    };

    pnvisualizerWidget.prototype.updateNode = function (desc) {
        if (desc) {
    ...
    pnvisualizerWidget.prototype.onNodeClick = function (/*id*/) {
        // This currently changes the active node to the given id and
        // this is overridden in the controller.
    };

    pnvisualizerWidget.prototype.onBackgroundDblClick = function () {
