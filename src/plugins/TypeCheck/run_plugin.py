"""
This script is called by the plugin-wrapper, TypeCheck.js, which passes down the
...
plugin = TypeCheck(webgme, COMMIT_HASH, BRANCH_NAME, ACTIVE_NODE_PATH, ACTIVE_SELECTION_PATHS, NAMESPACE)
